...
import { cakeInsert,cakeInsertMany,cakeUpdate,cakeDelete,cakeDetail,cakeList } from '../controllers/cakes'
import { verify } from '../controllers/token'
let router = new Router();
router.get('/',cakeList)
router.post('/insert',verify,cakeInsert)
router.post('/insert_many_for_test',verify,cakeInsertMany)
